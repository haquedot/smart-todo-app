    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/30 transition-all duration-700 ease-in-out">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <motion.div
          ...
          className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/50 p-6 mb-6 transition-all duration-700 ease-in-out"
        >
          {/* Header */}
          <div className="flex items-center justify-between mb-6 p-4 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 dark:from-blue-600/20 dark:via-purple-600/20 dark:to-pink-600/20 rounded-xl border border-blue-200/30 dark:border-blue-700/30">
            <motion.h1
              className="text-3xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <div className="flex items-center gap-2">
              <Button 
                ...
                className="gap-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:from-purple-600/20 dark:to-pink-600/20 border-purple-300/50 dark:border-purple-700/50 hover:from-purple-500/20 hover:to-pink-500/20 dark:hover:from-purple-600/30 dark:hover:to-pink-600/30"
              >
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 dark:from-blue-600/20 dark:to-indigo-600/20 border-blue-300/50 dark:border-blue-700/50 hover:from-blue-500/20 hover:to-indigo-500/20 dark:hover:from-blue-600/30 dark:hover:to-indigo-600/30"
              >
          ...
          {/* Task Input */}
          <motion.div
            className="flex gap-2 mb-6 p-4 bg-gradient-to-r from-emerald-50/50 via-teal-50/50 to-cyan-50/50 dark:from-emerald-900/20 dark:via-teal-900/20 dark:to-cyan-900/20 rounded-xl border border-emerald-200/30 dark:border-emerald-700/30"
          ...
          >
            <Button 
              ...
              className="gap-2 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-900/30 dark:to-indigo-900/30 border-blue-300/50 dark:border-blue-700/50 hover:from-blue-100/70 hover:to-indigo-100/70 dark:hover:from-blue-900/50 dark:hover:to-indigo-900/50"
            >
            ...
            <Button 
              ...
              size="sm" 
              asChild 
              className="gap-2 bg-gradient-to-r from-emerald-50/50 to-teal-50/50 dark:from-emerald-900/30 dark:to-teal-900/30 border-emerald-300/50 dark:border-emerald-700/50 hover:from-emerald-100/70 hover:to-teal-100/70 dark:hover:from-emerald-900/50 dark:hover:to-teal-900/50"
            >
